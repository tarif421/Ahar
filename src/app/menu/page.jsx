    ...
    <div className="py-12 bg-transparent">
      ...
      <div className="text-center max-w-2xl mx-auto space-y-3 mb-10 px-4">
        ...
        <h2 className="text-3xl sm:text-4xl font-black text-foreground tracking-tight leading-tight">
          Total <span className="bg-gradient-to-r from-primary via-secondary to-accent bg-clip-text text-transparent">{foods.length}</span> Premium Foods on Menu
        </h2>
        
        {/* Subtle Subtitle */}
        <p className="text-xs sm:text-sm font-medium text-slate-500 dark:text-slate-400">
          Handpicked culinary delights prepared with organic ingredients and true passion.
        </p>
      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6 px-4 sm:px-8 lg:px-16">
        {foods.map((food) => (
